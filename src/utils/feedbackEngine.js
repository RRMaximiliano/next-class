...
export const generateFeedback = (analysis) => {
    ...
    if (metrics.longestTurnDuration > 300) { // 5 mins
        collectedInsights.push({
            ...
            recommendation: 'We detected extended periods of uninterrupted teacher talk (> 5 mins). Attention spans drift after 10 minutes. Insert a "Turn-and-Talk" or quick poll to reset engagement.'
        });
    }
    ...
    return {
        ...
        styleDefinitions: {
            'Lecturer': 'Primarily teacher-led (>80% talk). Efficient for content but lower engagement.',
            'Hybrid': 'Balanced approach (40-80% talk). Mixes instruction with interaction.',
            'Facilitator': 'Student-centered (<40% talk). Teacher guides rather than directs.'
        }
    };
};
